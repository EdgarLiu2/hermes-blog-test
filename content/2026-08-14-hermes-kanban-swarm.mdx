...
author: "EdgarLiu2"
description: "Kanban Swarm v1 是 Hermes Agent 在 v0.15.0（\"Velocity Release\"，2026-05-28）引入的多智能体编排原语：它**不引入新的调度器**，而是把一棵\"并行 worker → 门控 verifier → 门控 synthesizer\"的任务图，以"
---
